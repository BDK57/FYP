...
const Hero = () => {
            ...
            <section className={`hero__section relative h-full`}>
                ...
                <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] " style={{ width: "calc(100% - 32px)" }}>
                    <div className="relative flex flex-col justify-center container mx-auto">
                        ...
                        <h1 className={'hero__title'}>AURORA</h1>
                        <h3 className={'hero__desk'}>BANQUET HALL</h3>
                        <div className={'hero__since_wrapper'}>
                            <h4 className={'hero__since'}>since 2018</h4>
    ...
    lg:after:z-[-1]`}>
                ...
                >
                    ...
                    <SwiperSlide>
                        <div>
                            <a className="event_item__wrapper" draggable="false" href="/events#weddings">
                                {/* <picture>
                                        <source media="(min-width: 1920px)" srcSet="/assets/homepage/events/Events_1920_Weddings.webp" type="image/webp" />
                                        <source media="(min-width: 1920px)" srcSet="/assets/homepage/events/Events_1920_Weddings.jpg" />
                                        <source media="(min-width: 768px)" srcSet="/assets/homepage/events/Events_Standard_Weddings.webp" type="image/webp" />
                                        <source media="(min-width: 768px)" srcSet="/assets/homepage/events/Events_Standard_Weddings.jpg" />
                                        <source srcSet="/assets/homepage/events/Events_375_Weddings.webp" type="image/webp" />
                                        <img className="event_item__image ls-is-cached lazyloaded" src="/assets/homepage/events/Events_375_Weddings.jpg" alt title />
                                    </picture> */}

                                <Image
                                    src={"/assets/homepage/events/Events_375_Birthdays.jpg"}
                                    className=" sm:hidden max-w-[100%]  h-auto max-h-[150px] w-[150px]"
                                    style={{
                                        filter: "brightness(0.9)",
                                    }} layout='responsive' width={425}
                                    height={369}
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_Standard_Birthdays.jpg"}
                                    className="xl:hidden sm:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive' width={768}
                                    height={600}
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_Standard_Birthdays.jpg"}
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_1920_Birthdays.jpg"}
                                ...
                                >
                                    ...
                                    >
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">Birthday</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <SwiperSlide>
                        <div>
                            <a className="event_item__wrapper" draggable="false" href="/events#weddings">
                                ...
                                <Image
                                    src={"/assets/homepage/events/Events_375_Weddings.jpg"}
                                    className=" sm:hidden max-w-[100%]  h-auto max-h-[150px] w-[150px]"
                                    style={{
                                        filter: "brightness(0.9)",
                                    }} layout='responsive' width={425}
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_Standard_Weddings.jpg"}
                                    className="xl:hidden sm:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive' width={768}
                                    height={600}
                                />
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_1920_Weddings.jpg"}
                                    className="2xl:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive'
                                    width={1920}
                                    height={1500}
                                ...
                                >
                                    ...
                                    >
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">Weddings</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <SwiperSlide>
                        <div>
                            <a className="event_item__wrapper" draggable="false" href="/events#weddings">
                                ...
                                <Image
                                    src={"/assets/homepage/events/Events_375_EventsbyAurora.jpg"}
                                    className=" sm:hidden max-w-[100%]  h-auto max-h-[150px] w-[150px]"
                                    style={{
                                        filter: "brightness(0.9)",
                                    }} layout='responsive' width={425}
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_Standard_EventsbyAurora.jpg"}
                                    className="xl:hidden sm:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive' width={768}
                                    height={600}
                                />
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_1920_EventsbyAurora.jpg"}
                                    className="2xl:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive'
                                    width={1920}
                                    height={1500}
                                ...
                                >
                                    ...
                                    >
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">events by </span>
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">auroras </span>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <SwiperSlide>
                        <div>
                            <a className="event_item__wrapper" draggable="false" href="/events#weddings">
                                ...
                                <Image
                                    src={"/assets/homepage/events/Events_375_CorporateEvents.jpg"}
                                    className=" sm:hidden max-w-[100%]  h-auto max-h-[150px] w-[150px]"
                                    style={{
                                        filter: "brightness(0.9)",
                                    }} layout='responsive' width={425}
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_Standard_CorporateEvents.jpg"}
                                    className="xl:hidden sm:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive' width={768}
                                    height={600}
                                />
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_1920_CorporateEvents.jpg"}
                                    className="2xl:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive'
                                    width={1920}
                                    height={1500}
                                ...
                                >
                                    ...
                                    >
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">Corporate  </span>
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">Events </span>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <SwiperSlide>
                        <div>
                            <a className="event_item__wrapper" draggable="false" href="/events#weddings">
                                ...
                                <Image
                                    src={"/assets/homepage/events/Events_375_OffsiteEvents.jpg"}
                                    className=" sm:hidden max-w-[100%]  h-auto max-h-[150px] w-[150px]"
                                    style={{
                                        filter: "brightness(0.9)",
                                    }} layout='responsive' width={425}
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_Standard_OffsiteEvents.jpg"}
                                    className="xl:hidden sm:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive' width={768}
                                    height={600}
                                />
                                ...
                                />
                                <Image
                                    src={"/assets/homepage/events/Events_1920_OffsiteEvents.jpg"}
                                    className="2xl:block hidden rounded-xl  max-w-[100%]  h-auto"
                                    style={{ filter: "brightness(0.9)" }} layout='responsive'
                                    width={1920}
                                    height={1500}
                                ...
                                >
                                    ...
                                    >
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">Offsite  </span>
                                        <span className="tracking-[3.6px] leading-6 text-white text-lg font-[Cinzel] font-extralight">Events </span>
                                    </div>
                                </div>
                            </a>
...
h-full
    ...
    mb-5"
                            >
                                <Image src={"/assets/icons/star-1.svg"} width={20} height={20}></Image>
                                <Image src={"/assets/icons/star-1.svg"} width={20} height={20}></Image>
                                <Image src={"/assets/icons/star-1.svg"} width={20} height={20}></Image>
                                <Image src={"/assets/icons/star-1.svg"} width={20} height={20}></Image>
                                <Image src={"/assets/icons/star-1.svg"} width={20} height={20}></Image>
