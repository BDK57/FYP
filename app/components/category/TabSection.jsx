...
import AccordianCheckBox from "@/app/components/microCompoments/AccordianCheckBox";
    ...
    children: (
      <>
        ...
        <div className="flex items-start flex-col ">
          <h1 className="text-3xl mb-2 font-semibold">Verify Pricing</h1>

          <div
            className=" rounded-2xl profile_deals__1ZwS0 bg-secColor h-28  flex flex-row justify-center items-center w-full"
            style={{
              backgroundImage: "url(assets/icons/golden-sparkle-2.svg)",
              backgroundPosition: "right 100px top 100px",
              backgroundRepeat: "repeat",
              backgroundSize: "2em 2em",
            }}
          >
            <div className="flex justify-evenly gap-2 lg:px-6 items-center">
              <div className="profile_dealTextContainer__2woy2">
                <div className="text-white flex">
                  <div className="text-4xl mx-2">Deals</div>
                  <div className="profile_dealTitle__3O5lA text-white text-xl space-x-2">
                    : <span>Free customized 3 tiered wedding cake</span>
                  </div>
                </div>
                <div className="profile_dealText__2f7yP text-white text-lg">
                  Only available on Shadiyana. T&amp;Cs apply.
                </div>
              </div>
              <div className="profile_dealButtonContainer__1Wm28">
                <button
                  className="profile_dealButton__tUeq3  border-none
    text-mainColor
    font-semibold
    text-lg
    leading-5
...
rounded-xl
 px-5 py-2
                  ...
                  style={{
                    animation:
                      "profile_pulse__1Z_on .4s ease infinite alternate",
                  }}
                >
                  Get Discount
                </button>
      ...
      <br /> */}
        ...
        <div className="flex items-start flex-col my-5 ">
          ...
          <Link href="https://www.google.com/maps/dir//google+maps+bb+banquet/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x3eb33b30a690881b:0xc19b8ee0dfd357f3?sa=X&ved=2ahUKEwjHu6XV7puDAxXExgIHHXu4CUEQ9Rd6BAg4EAA" className="w-full">
          <Image
        ...
        <div className="block">
          ...
          <p className="text-sm font-semibold ml-14">
            The food was simply exquisite , elegant
          </p>
        </div>
      ...
      <div className="container mx-auto px-5">
        <div className="mainSection flex mt-5 md:gap-10">
          ...
          <div className="w-2/4">
            ...
            <Link href={""}>
              <div className="standrad-btn-normal-border-radius">
                <p className="text-white font-bold text-sm ml-1">
                  Deals
                  <span className="text-white font-normal">: Free customized 3 tiered wedding cake</span>
                </p>
              </div></Link>
